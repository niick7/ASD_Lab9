...
public class GumballMachine {
  ...
  public void insertQuarter() throws IllegalAccessException {
    this.state = state.insertQuarter();
  }

  public void ejectQuarter() throws IllegalAccessException {
    this.state = state.ejectQuarter();
  }

  public void turnCrank() throws IllegalAccessException {
